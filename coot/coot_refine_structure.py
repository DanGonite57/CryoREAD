...
def coot_refine_structure(
    input_cif_path, input_map_path, output_cif_path, coot_software="coot"
):
    """
    ...
    with open(script_path, "w") as file:
        ...
        file.write("\n")
        file.write(
            'real_space_atom_residuerefine_output("%s","%s","%s",%f)'
            % (input_map_path, input_cif_path, output_cif_path, min_value)
        )
