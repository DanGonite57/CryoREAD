...
def save_dens_map(save_map_path, new_dens, origin_map_path):
...
def save_predict_specific_map(
    save_map_path, specific_class, prediction_array, origin_map_path, label_only=False
):
